    ...
    <>
      <tr key={appointment.uuid} className="hover:bg-indigo-100 text-center">
        ...
        <td className="whitespace-normal break-words">
          <input
            className={`${showEdit ? 'bg-inherit' : ''} text-center`}
            disabled={showEdit}
            value={name}
        ...
        <td className="whitespace-normal break-words">
          <input
            className={`${showEdit ? 'bg-inherit' : ''} text-center ${emailError ? 'input-error' : ''}`}
            disabled={showEdit}
            value={email}
        ...
        <td className="whitespace-normal break-words">
          <input
            className={`${showEdit ? 'bg-inherit' : ''} text-center ${phoneError ? 'input-error' : ''}`}
            disabled={showEdit}
            value={phone}
        ...
        <td className="whitespace-normal break-words">
          <input
            className={`${showEdit ? 'bg-inherit' : ''} text-center placeholder:text-black`}
            disabled={showEdit}
            value={petName}
        ...
        <td className="whitespace-normal break-words">
          <select
            className={`${showEdit ? 'bg-inherit' : ''} text-center disabled:bg-inherit disabled:text-black`}
            disabled={showEdit}
