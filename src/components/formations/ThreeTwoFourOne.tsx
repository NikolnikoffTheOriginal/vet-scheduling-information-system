...
interface IThreeTwoFourOne {
  ...
  setSecondCenterDefensiveMidfield: (value: string) => void,
  setRightWing: (value: string) => void,
  setLeftWing: (value: string) => void,
}

export const ThreeTwoFourOne = ({
  squad,
  setGoalkeeper,
  setFirstCenterBack,
  setSecondCenterBack,
  ...
  <div className="flex pl-3">
    <div className="flex flex-col">
      ...
      <div className="flex">
        <select className="select select-accent w-full max-w-xs mb-3" defaultValue={"CF"} onChange={(e) => setFirstCenterForward(e.target.value)}>
